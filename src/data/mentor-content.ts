...
export const RECOGNITION_DRILLS: RecognitionDrill[] = [
  ...
  { id: 'rec-prefix-sum', problemTitle: 'Subarray Sum Equals K', level: 3, prompt: 'Count contiguous subarrays whose values sum exactly to K, including when values may be negative.', clues: ['Contiguous sums', 'Negative values prevent a monotonic window'], answer: 'Prefix Sum', options: ['Prefix Sum', 'Sliding Window', 'Two Pointers', 'Dynamic Programming'], explanation: 'A prior prefix equal to current prefix minus K identifies each valid starting boundary.' },
  ...
  { id: 'rec-reverse-linked', problemTitle: 'Reverse Linked List', level: 3, prompt: 'Reverse every next pointer in a singly linked list without losing the unprocessed suffix.', clues: ['References must be rewired in place', 'The remaining chain can be lost'], answer: 'Linked Lists', options: ['Linked Lists', 'Two Pointers', 'Stack', 'Trees'], explanation: 'Save the next node before redirecting the current pointer, then advance the previous/current pair.' },
  { id: 'rec-merge-intervals', problemTitle: 'Merge Intervals', level: 3, prompt: 'Combine every overlapping range into disjoint ranges.', clues: ['Ranges become local after sorting', 'Only the active end boundary matters'], answer: 'Intervals', options: ['Intervals', 'Two Pointers', 'Greedy', 'Stack'], explanation: 'Sort by start so each interval can overlap only the current merged tail.' },
  { id: 'rec-tree-depth', problemTitle: 'Maximum Depth of Binary Tree', level: 3, prompt: 'Return the longest root-to-leaf depth of a binary tree.', clues: ['Parent answer depends on child answers', 'The structure is recursive'], answer: 'Trees', options: ['Trees', 'Graph BFS', 'Dynamic Programming', 'Backtracking'], explanation: 'Each subtree returns its depth; the parent returns one plus the larger child result.' },
  ...
  { id: 'rec-jump-game', problemTitle: 'Jump Game', level: 4, prompt: 'Decide whether forward jumps can reach the final position.', clues: ['Only the farthest reachable frontier matters', 'A locally dominated state can be discarded'], answer: 'Greedy', options: ['Greedy', 'Dynamic Programming', 'Graph BFS', 'Sliding Window'], explanation: 'Maintain the farthest reachable index; any position inside that frontier can safely extend it.' },
  { id: 'rec-single-number', problemTitle: 'Single Number', level: 4, prompt: 'Find the one value appearing once when every other value appears exactly twice.', clues: ['Pairs cancel', 'Constant extra space is required'], answer: 'Bit Manipulation', options: ['Bit Manipulation', 'Arrays & Hashing', 'Dynamic Programming', 'Binary Search'], explanation: 'XOR cancels equal pairs and leaves the unique value.' },
  { id: 'rec-trie', problemTitle: 'Implement Trie Prefix Tree', level: 4, prompt: 'Support insert, full-word search, and prefix search over many strings.', clues: ['Queries share prefixes', 'Characters form reusable edges'], answer: 'Tries', options: ['Tries', 'Arrays & Hashing', 'Trees', 'Graph DFS'], explanation: 'A trie stores each shared prefix once and marks which paths end complete words.' },
